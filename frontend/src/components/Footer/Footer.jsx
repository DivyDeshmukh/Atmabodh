...
import countryCode from "../LandingPage/data/countryCode";
import cities from "../LandingPage/data/cities";
...
function Footer() {
  ...
  return (
    <div className="pt-12">
      <div className="bg-[#1b181f] h-auto w-full flex flex-col gap-8 pt-12 px-2 md:px-8 lg:px-24 xl:px-56 overflow-x-hidden font-bold">
        ...
        >
          <div className="flex text-left items-center gap-1 md:gap-1 justify-center translate-y-2 -translate-x-9">
            ...
            {/* <h1 className="text-xs sm:text-sm md:text-base lg:text-lg text-white"></h1> */}
          </div>
          <div
            id="footer-parts"
